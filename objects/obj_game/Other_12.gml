...
else
{
	for(var i = 0; i < ds_list_size(global.p1destroyed); i++)
	{
		...
		{
			ds_list_add(global.p1Respawning, ds_list_find_value(global.p1destroyed, i));
...
else
{
	for(var i = 0; i < ds_list_size(global.p2destroyed); i++)
	{
		...
		{
			ds_list_add(global.p2Respawning, ds_list_find_value(global.p1destroyed, i));
