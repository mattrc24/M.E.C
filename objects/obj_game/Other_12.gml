...
else
{
	...
	{
		for(var j = 0; j < ds_list_size(global.p1Respawning); j++)
		{
			if(ds_map_find_value(global.p1Respawning, "hp") == 0)
			{
				ds_list_insert(global.p1Respawning, j, ds_list_find_value(global.p1destroyed, i));
...
else
{
	...
	{
		for(var j = 0; j < ds_list_size(global.p2Respawning); j++)
		{
			if(ds_map_find_value(global.p2Respawning, "hp") == 0)
			{
				ds_list_insert(global.p2Respawning, j, ds_list_find_value(global.p1destroyed, i));
