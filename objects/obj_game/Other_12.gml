...
//combat lanes
for(var i = 0; i <= ds_list_size(global.p1combatla); i++)
{
...
{
	//player will choose cards to stay based on how many spots are available in 
	//respawn region
}
