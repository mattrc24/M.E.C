...
for (var i = 0; i < ds_list_size(global.p1Respawning); i++)
{
	...
	{
		ds_map_set(p1_card, "cooldown", (ds_map_find_value(p1_card, "cooldown")--));
	}
	...
	{
		ds_map_set(p2_card, "cooldown", (ds_map_find_value(p2_card, "cooldown")--));
	}
}
