...
for(var i = 9; i>=0;i--)
{
	...
	//show_message("Player 1 atk: " + string(p1atknum) + " Player 2 atk: " + string(p2atknum));
	...
	*/
	...
	else
	{
		...
		//show_message("Player 1 hp: " + string(p1hpnum) + " Player 2 hp: " + string(p2hpnum));
	/*
	**		ABILITIES
	**		
	**		ABILITY - PRIME MOVER
	...
	**			set p1atknum to 0
	*/			
				ds_map_replace(p2_card, "hp", p2hpnum);
				p1atknum=0;
	...
	**			set p2atknum to 0
	*/		
			ds_map_replace(p1_card, "hp", p1hpnum);
			p2atknum=0;
		}
	/*
	**
	...
	*/	if(p1hpnum >0 && p2hpnum>0)
	...
	//			then reduce each card hp value by the opposing card hp value
			p1hpnum -=	p2atknum;//these are correct, they get reverted later somehow
			p2hpnum	-=	p1atknum;
			//show_message("Player 1 atk both: " + string(p1atknum) + " Player 2 atk both: " + string(p2atknum));
			//show_message("Player 1 hp both: " + string(p1hpnum) + " Player 2 hp both: " + string(p2hpnum));
	...
	*/		if( ds_map_find_value( p1_base_card,"name") != "Base Card"/*&&  ds_map_find_value( p1_base_card,"name") != "empty"*/)
	...
	//					reduce corresponding player's base card hp by 1
		...
		**********************************************/
		...
		//p1hpnum=ds_map_find_value(ds_list_find_value(global.p1combatlane, i), "hp");
		//p2hpnum=ds_map_find_value(ds_list_find_value(global.p2combatlane, i), "hp");
		
		//show_message("Player 1 hp end: " + string(p1hpnum) + " Player 2 hp end: " + string(p2hpnum));
}
