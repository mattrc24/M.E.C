...
for(var i = 9; i>=0;i--)
{
	...
	p2_card=ds_list_find_value( global.p2combatlane,9-i);
	...
	p2_base_card=ds_list_find_value(global.p2baselane,(9-i)/2)
	...
	*/	if(ds_map_find_value(p1_card,"Name") == "Cannon" && p1hpnum>0)
		{
	...
	*/			p1atknum=0;
	...
	//		if p2 card is a cannon
		if(ds_map_find_value(p2_card,"name") == "Cannon"&& p2hpnum>0)
		{
	/*			then subtract 1 from the p2 base hp value
	**				if the base card is not named "base card" or "empty"
