...
{
	case 1: 
	ds_list_delete(global.p1hand, index);
	global.tempCard = values;
	global.cardselected = tempCard;
	break;
	
	case 2: 
	ds_list_delete(global.p2hand, index);
	global.tempCard = values;
	global.cardselected = tempCard;
	break;
